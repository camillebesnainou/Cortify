                          ...
                          onPressed: () async {
                            ...
                            if (_controller.value.isPlaying) {
                              setState(() {
                                ...
                                // Go back 5 seconds
                                var newPosition = currentPosition != null
                                    ? currentPosition - Duration(seconds: 5)
                                    : Duration(seconds: 0); // go back 5 seconds
                                ...
                                logToFile(
                                    DateTime.now().toString(),
                                    'USER_ACTION',
                                    'Pause button pressed. Pausing video at $currentPosition. Rewind playback 5sec to $newPosition.',
                                    widget.logFile);
